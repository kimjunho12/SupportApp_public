...
public class category_adapter extends RecyclerView.Adapter<category_adapter.CustomViewHolder> {
    ...
    public category_adapter(ArrayList<bottom_favorite_profile_model> arrayList, Context context) {
    ...
    @NonNull
    @Override
    public category_adapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull category_adapter.CustomViewHolder holder, int position) {
